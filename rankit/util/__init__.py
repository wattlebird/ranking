...
__all__=['Converter', 'ConsistancyMatrix', 'fast_colley_matrix_build',
'fast_colley_vector_build', 'fast_rate_diff_vote_matrix_build',
'fast_simple_diff_vote_matrix_build', 'fast_rate_vote_matrix_build']
